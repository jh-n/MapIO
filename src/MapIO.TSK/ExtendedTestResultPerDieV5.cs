...
namespace MapIO.TSK
{
    public class ExtendedTestResultPerDieV5 : BinarySection, IHaveExtendedBinaryCategory, IHaveExtendedTestExecutionSite
    {
        public static readonly int SIZE = 4;

        public ExtendedTestResultPerDieV5(BinarySection source, long offset) : base(source, offset)
        {
        }
        ...
        /// <summary>
        /// 0 to 2047 (add 1 for actual test execution site)
        /// </summary>
        public int ExtendedTestExecutionSite
        {
            get => Word1st & 0b1111_1111_1111;
            set => Word1st = (Word1st & 0b1111_0000_0000_0000) | (value & 0b1111_1111_1111);
        }
